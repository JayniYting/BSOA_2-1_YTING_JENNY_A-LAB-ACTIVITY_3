 ...
 * Slug: corporate-firm/index-header-image
 * Categories: corporate-firm, index-header-image
 */
?>
...
<h2 class="wp-block-heading has-text-align-center" style="text-transform:uppercase"><?php echo esc_html__('blog','corporate-firm'); ?></h2>
<!-- /wp:heading --></div></div>
<!-- /wp:cover -->