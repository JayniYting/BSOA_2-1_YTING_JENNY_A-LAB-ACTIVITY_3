...
/**
 * Title: Page Title
 * Slug: farm-cultivation/page-title
 * Categories: farm-cultivation, page-title
 */
?>

<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() . '/images/banner.png'); ?>","id":6,"dimRatio":50,"minHeight":400,"className":"inner-cover-img","layout":{"type":"constrained","contentSize":"90%"}} -->
