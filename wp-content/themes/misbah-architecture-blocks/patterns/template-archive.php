 ...
 * Slug: misbah-architecture-blocks/template-archive
 * Categories: template
 * Inserter: false
 */
...
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:66.666%"><!-- wp:query-title {"type":"archive","textAlign":"center","showPrefix":false,"align":"wide"} /-->
...
<!-- wp:template-part {"slug":"footer","theme":"misbah-architecture-blocks","tagName":"footer"} /-->